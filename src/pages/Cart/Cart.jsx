              ...
              <div className="horizontal-card-details">
                ...
                <div className="qty-section">
                  <button
                    ...
                    id="decrease-qty"
                    onClick={() => decreaseHandler(items._id)}
                    disabled={items.qty === 1 || btnDisable}
                  >
                    -
                  </button>
                  ...
                  <button
                    className="btn btn-primary"
                    id="increase-qty"
                    onClick={() => increaseHandler(items._id)}
                    disabled={items.qty === 10 || btnDisable}
                  >
                    +
                  </button>
                </div>
            ...
            <div className="product-card">
              ...
              <div className="coupon-section">
                <input
                  ...
                  id="email"
                />
                <button className="btn btn-primary" id="apply-coupon">
                  Apply
                </button>
              </div>
              ...
              <div className="price-summary">
                ...
                <span className="price">
                  <strong className="price" id="delivery-charge">
                    ₹ 0
                  </strong>
